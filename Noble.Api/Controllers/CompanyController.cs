...
using Focus.Business.DailyExpenses.Commands.DeleteDailyExpenses;
...
namespace Noble.Api.Controllers
{
    ...
    public class CompanyController : BaseController
    {
       ...
       // [Roles("CanEditTerminal", "Noble Admin")]
        ...
        public async Task<IActionResult> AutoGenerateCode()
        {
        ...
        public async Task<IActionResult> SaveDailyExpense([FromBody] DailyExpenseVm dailyExpense)
        {
            ...
            message = await Mediator.Send(new AddUpdateDailyExpenseCommand
            {
        ...
        public async Task<IActionResult> DailyExpenseList(ApprovalStatus status, string searchTerm, int? pageNumber, DateTime? fromDate, DateTime? toDate, string paymentMode, string referenceNo, decimal? totalAmount)
        {
        ...
        [Roles("Noble Admin", "CanViewAccountLedger", "CanPrintAccountLedger")]
        public async Task<IActionResult> GetCostCenterWiseLedgerLedgerList([FromBody] List<TrialBalanceModel> accounts, DateTime fromDate, DateTime toDate, int? pageNumber, bool isLedger, string dateType)
        {
        ...
        public async Task<IActionResult> GetContactOpeningBalanceList(Guid accountId, DateTime fromDate, DateTime toDate, int? pageNumber, bool isReport)
        {
        ...
        [Roles("User", "Super Admin", "Admin", "Supervisor", "Noble Admin")]
        public async Task<IActionResult> AddFinancialYear(string year, int month)
        {
        ...
        {
            var latestYear = _Context.YearlyPeriods.AsNoTracking()
                .OrderBy(x => x.Name)
                .ToList();
