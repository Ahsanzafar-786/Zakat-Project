...
namespace Focus.Persistence.Migrations
{
    ...
    [Migration("20231121104847_PaymentAuthorizePerson")]
    partial class PaymentAuthorizePerson
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Focus.Domain.Entities.CharityTransaction", b =>
                {
                    ...
                    b.Property<bool>("PaymentByAuthorizePerson")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Focus.Domain.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CashVoucher = false,
                            CompanyRegNo = "56ty60",
                            CreatedDate = new DateTime(2023, 11, 21, 10, 48, 45, 550, DateTimeKind.Utc).AddTicks(370),
                            DayStart = false,
                            English = false,
            ...
            modelBuilder.Entity("Focus.Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<Guid?>("PaymentAuthorizePersonId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PaymentAuthorizePersonId");
            ...
            modelBuilder.Entity("Focus.Domain.Entities.PaymentAuthorizePerson", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("AuthorizePersonId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AuthorizePersonId");

                    b.HasIndex("CompanyId");

                    b.HasIndex("PaymentId");

                    b.ToTable("PaymentAuthorizePersons");
                });

            modelBuilder.Entity("Focus.Domain.Entities.PaymentAuthorizePersonItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PaymentAuthorizePersonItems");
                });
            ...
            modelBuilder.Entity("Focus.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("Focus.Domain.Entities.PaymentAuthorizePerson", "PaymentAuthorizePerson")
                        .WithMany("Payments")
                        .HasForeignKey("PaymentAuthorizePersonId");
                    ...
                    b.Navigation("PaymentAuthorizePerson");
                });

            modelBuilder.Entity("Focus.Domain.Entities.PaymentAuthorizePerson", b =>
                {
                    b.HasOne("Focus.Domain.Entities.AuthorizedPerson", "AuthorizedPerson")
                        .WithMany("PaymentAuthorizePersons")
                        .HasForeignKey("AuthorizePersonId");
                    ...
                    b.HasOne("Focus.Domain.Entities.Payment", null)
                        .WithMany("PaymentAuthorizePersons")
            ...
            modelBuilder.Entity("Focus.Domain.Entities.PaymentAuthorizePersonItem", b =>
                {
                    b.HasOne("Focus.Domain.Entities.Beneficiaries", "Beneficiaries")
                        .WithMany("PaymentAuthorizePersonItems")
                        .HasForeignKey("BenificayId");
            ...
            modelBuilder.Entity("Focus.Domain.Entities.AuthorizedPerson", b =>
                {
                    ...
                    b.Navigation("PaymentAuthorizePersons");
                });
            ...
            modelBuilder.Entity("Focus.Domain.Entities.Beneficiaries", b =>
                {
                    ...
                    b.Navigation("PaymentAuthorizePersonItems");
