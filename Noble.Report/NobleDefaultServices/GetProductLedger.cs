...
namespace Noble.Report.NobleDefaultServices
{
    public static class GetProductLedger
    {
        ...
        public static List<ProductLedgerModel> GetProductLedgerDtl(string ProductId,string fromdate,string todate,string token,string serverName) {
            ...
            RestRequest request1 = new RestRequest("Report/ProductLedgerReport?productId=" + ProductId + "&fromDate=" + fromdate + "&toDate=" + todate);
