<template>
    ...
    <body>
        ...
        <!--end logo-->
        <div class="menu-content h-100" data-simplebar v-if="isHrPortal">
            ...
            <ul class="metismenu left-sidenav-menu">
                ...
                <li @click="SaleValueChange(true)" v-if="(IsSimpleInvoice || AllSale) && (isValid('CanAddQuotation') || isValid('CanDraftQuotation') || isValid('CanViewQuotation')
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li v-if="isValid('CanViewProforma')">
                            <a v-on:click="GoTo('/ServiceProformaInvoice', 'Sales_token', 'true', 'ProformaInvoices')" href="javascript:void(0);">{{ $t('Dashboard.ProformaInvoices') }} </a>
                        ...
                        <li v-if="isValid('CustomerPurchaseOrder')">
                            <a v-on:click="GoTo('/CommingSoon')" href="javascript:void(0);"> {{ $t('Dashboard.CustomerPurchaseOrder') }}</a>
                        </li>
                ...
                <li v-if="isValid('QuickItemRegistration') ||isValid('InventoryReports') ||isValid('PriceManagement') ||isValid('InventoryCountManagement')
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li v-if="isValid('PriceManagement')">
                            <a href="javascript:void(0);">
                                <i class="ti-control-record"></i>{{ $t('Dashboard.PriceManagement') }}<span class="menu-arrow left-has-menu">
                                    <i class="mdi mdi-chevron-right"></i>
                                </span>
                            </a>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <li>
                                    <a v-on:click="GoTo('/CommingSoon')" href="javascript:void(0);"> {{ $t('Dashboard.Price') }}</a>
                                </li>
                                <li>
                                    <a v-on:click="GoTo('/CommingSoon')" href="javascript:void(0);"> {{ $t('Dashboard.PriceReports') }}</a>
                                </li>
                                <li>
                                    <a v-on:click="GoTo('/PriceLabeling', 'Product And Inventory Management_token', 'true')" href="javascript:void(0);"> {{ $t('Dashboard.PriceLabeling') }}</a>
                                </li>
                                <li>
                                    <a v-on:click="GoTo('/PriceRecord', 'Product And Inventory Management_token', 'true')" href="javascript:void(0);"> {{ $t('Dashboard.PriceRecord') }}</a>
                                </li>
                            </ul>
                        </li>
                ...
                <li v-if="isValid('WarehouseGatePass') ||isValid('WareHouseReport') ||isValid('CanViewWareHouse') || isValid('CanAddWareHouse') || isValid('CanViewStockIn')
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li v-if="isValid('WarehouseGatePass')">
                            <a v-on:click="GoTo('/Region')" href="javascript:void(0);">Region</a>
                        </li>
                ...
                <li v-if="isValid('PurchaseBillingManagement') ||isValid('PurchaseDeliveryManagement') ||isValid('PurchaseReport') ||isValid('GoodReceives')
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li v-else-if="isValid('CanAddSupplier')">
                            <a v-on:click="GoTo('/addsupplier', 'Purchase_token', 'true')" href="javascript:void(0);"> {{ $t('Dashboard.Suppliers') }}</a>
                        </li>
                ...
                <li v-if="isValid('InventoryItemLookUp') ||isValid('EmailManagement') ||isValid('SmsManagement') ||isValid('CanPrintRackBarcode') || isValid('CanPrintItemBarcode') || isValid('CanBackUpData') || isValid('CanRestoreData')">
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a v-on:click="GoTo('/CommingSoon')" href="javascript:void(0);"> {{ $t('Dashboard.BarcodeSetup') }}</a>
                        </li>
                        <li>
                            <a v-on:click="GoTo('/CommingSoon')" href="javascript:void(0);"> {{ $t('Dashboard.Reports') }}</a>
                        </li>
                ...
                <li v-if="isValid('EmailManagement')">
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a v-on:click="GoTo('/CommingSoon')" href="javascript:void(0);"> {{ $t('Dashboard.Emails') }}</a>
                        </li>
                        <li>
                            <a v-on:click="GoTo('/CommingSoon')" href="javascript:void(0);"> {{ $t('Dashboard.Reports') }}</a>
                        </li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li v-if="isValid('CanViewStockReport') || isValid('CanViewProductInventoryReport')">
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                ...
                                <li>
                                    <a v-on:click="GoTo('/ProductComparisonReport', 'Reporting_token', 'true')" href="javascript:void(0);"> Product Wise Account Reports </a>
                                </li>
                                <li>
                                    <a v-on:click="GoTo('/ProductLedgerReport', 'Reporting_token', 'true')" href="javascript:void(0);"> Product Ledger Report</a>
                                </li>
                                <li>
                                    <a v-on:click="GoTo('/ComparisionLedgerReport', 'Reporting_token', 'true')" href="javascript:void(0);"> Comparision Product Report</a>
                                </li>
                ...
                <li v-if="isValid('CanViewUserRole') || isValid('CanViewUserPermission') || isValid('CanViewSignUpUser') || isValid('CanViewTerminal')
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li v-if="isValid('CanViewTerminal')">
                        ...
                        <li>
                            <a v-on:click="GoTo('/Prefixes', 'Settings And Permission_token','true')" href="javascript:void(0);"> Prefixes</a>
                        </li>
        ...
        <div class="topbar">
            ...
            <nav class="navbar-custom">
                <ul class="list-unstyled topbar-nav float-end mb-0">
                    ...
                    <li class="dropdown" v-if="isValid('EmployeePortalActivation') && isHrPortal">
