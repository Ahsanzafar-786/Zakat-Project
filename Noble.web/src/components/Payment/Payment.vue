<template>
    <div>
        ...
        <div class="page-header" style="height: 100px;">
            I'm The Header
            <br />
            <button @click="printPage" style="background: pink">PRINT ME!</button>
        </div>

        <!-- Page Footer -->
        <div class="page-footer"
            style="height: 50px; position: fixed; bottom: 0; width: 100%; border-top: 1px solid black; background: yellow;">
            I'm The Footer
        </div>
