    ...
    <div>
        <div hidden id='inventoryDetailReport' style="width: 100% !important;">
            ...
            <div class="page-header" style="text-align: center">
                <div style=" border:2px solid #000000;padding-top: 5px !important;padding-bottom: 5px !important;">
                        ...
                        <td>
                            ...
                            <div class="page">
                                <table class="table col-md-12 " style="direction: rtl !important;">
                                    <thead
                                        style="font-size:18px;color:black !important;color:black;border-top:0px !important">
