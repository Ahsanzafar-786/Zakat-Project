        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" v-model="brand.advancePayment " type="number" />
                </div>
                <div class="col-md-6">
                    <label class="text  font-weight-bolder">
            ...
            <div class="row">
                ...
                <div class="col-md-3" v-if="brand.durationType=='Customize'">
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            <tr v-for="(person , index) in brand.benificaryAuthorization" :key="index">
                                ...
                                <td class="border-top-0 text-center">
                                    <datepicker v-model="brand.startMonth" />
                            ...
                            <tr class="text-end">
                                <td colspan="5" class="border-top-0 text-end">
