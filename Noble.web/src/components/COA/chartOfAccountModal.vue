<template>
    ...
    <span class="modal-title" id="myModalLabel" v-else>{{type}} {{ $t('COA.Account') }}</span>-->
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div v-if="english=='true'" class="form-group" v-bind:class="{'has-danger': $v.account.name.$error, 'col-md-12' :type== 'Add' , 'col-md-12':type=='Edit' }">
                        <label>{{ $t('COA.NAME') |englishLanguage }}:<span class="text-danger"> *</span></label>
                    ...
                    <div v-if="isOtherLang()" class="form-group" v-bind:class="{'has-danger': $v.account.nameArabic.$error, 'col-md-12' :type== 'Add' , 'col-md-12':type=='Edit' }">
                        <label>{{ $t('COA.NAME') |arabicLanguage }}:<span class="text-danger"> *</span></label>
        ...
        <input v-model="account.openingBalance"  v-on:input="GetOpeningBalance(account.openingBalance)" class="form-control" type="number" />
    </div>-->
                    <!--<div class="form-group col-md-12">
...
<script>
    ...
    export default {
        mixins: [clickMixin],
        props: ['account', 'account-type-id', 'type', 'show'],
        data: function () {
            return {
                arabic: '',
                english: '',
