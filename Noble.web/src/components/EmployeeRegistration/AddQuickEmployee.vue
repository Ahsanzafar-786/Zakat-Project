        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row ">
                    ...
                    <div v-if="english=='true'" class="form-group has-label col-sm-12 " v-bind:class="{'has-danger' : $v.employee.englishName.$error}">
                        <label class="text  font-weight-bolder"> {{ $t('AddQuickEmployee.EmployeeName(English)') |englishLanguage}}:<span class="text-danger"> *</span> </label>
                    ...
                    <div v-if="isOtherLang()" class="form-group has-label col-sm-12 " v-bind:class="{'has-danger' : $v.employee.arabicName.$error}">
                        <label class="text  font-weight-bolder"> {{ $t('AddQuickEmployee.EmployeeName(Arabic)') |arabicLanguage}}:<span class="text-danger"> *</span> </label>
            ...
            <div class="modal-footer">
                <div class="modal-footer" v-if="type=='Edit'">
                    <button type="button" class="btn btn-soft-primary btn-sm " v-on:click="SaveEmployee" v-bind:disabled="$v.employee.$invalid"> {{ $t('AddQuickEmployee.btnUpdate') }}</button>
                    <button type="button" class="btn btn-soft-secondary btn-sm " v-on:click="close()">{{ $t('AddQuickEmployee.btnClear') }}</button>
                </div>
                <div class="modal-footer" v-else>
                    <button type="button" class="btn btn-soft-primary btn-sm  " v-on:click="SaveEmployee" v-bind:disabled="$v.employee.$invalid"> {{ $t('AddQuickEmployee.btnSave') }}</button>
                    <button type="button" class="btn btn-soft-secondary btn-sm " v-on:click="close()">{{ $t('AddQuickEmployee.btnClear') }}</button>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="modal-header" v-if="type=='Edit'">
                            ...
                            <h5 class="modal-title " id="myModalLabel"> {{ $t('AddQuickEmployee.UpdateEmployee') }}</h5>

                        </div>
                        <div class="modal-header" v-else>

                            <h5 class="modal-title " id="myModalLabel"> {{ $t('AddQuickEmployee.AddEmployee') }}</h5>
                        ...
                        <div class="modal-footer justify-content-right" v-if="type=='Edit'">
                            ...
                            <button type="button" class="btn btn-soft-primary btn-s  " v-on:click="SaveEmployee" v-bind:disabled="$v.employee.$invalid"> {{ $t('AddQuickEmployee.btnUpdate') }}</button>
