<template>
    <div>
        <multiselect v-model="DisplayValue" :options="options" :searchable="true" :multiple="false" :placeholder="$t('General.SelectBenificary')" track-by="name" :clear-on-select="false" :show-labels="false" label="name">
