<template>
    <div>
        ...
        <multiselect v-model="DisplayValue" v-else :options="options"  :multiple="false" :placeholder="$t('General.SelectExpenseCategory')" track-by="name" :clear-on-select="false" :show-labels="false" label="name" v-bind:class="$i18n.locale == 'en' ? 'text-left ' : 'multiselect__placeholder12'">
        </multiselect>      
    </div>
</template>
<script>
